...
/*!
 * If we have detected a reader with a display, use this to get a custom text formatter
 * for the current reader to display formatted text strings to the connected reader device.
 */
@property (nonatomic, readonly) PPHReaderDisplayFormatter *textFormatter;
