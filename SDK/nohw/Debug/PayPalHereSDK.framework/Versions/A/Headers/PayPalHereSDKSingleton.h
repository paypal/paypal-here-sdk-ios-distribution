...
#import "PPHCardReaderStateMonitor.h"
...
typedef NS_ENUM(NSInteger, PPHSDKServiceType) {
    ...
    /*!
     * SDK points to a mock environment. With this setup all responses will be "mocked" by the SDK.
     * Developer cannot review transaction logs at a later time. This setup is handy as a development
     * time tool to review and evaluate the experience and flow of the SDK
     */
    ePPHSDKServiceType_Mock
};
...
/*!
 * Holds the authoritative state of the card readers and running card data.
 */
+(PPHCardReaderStateMonitor*) sharedCardReaderStateMonitor;
 ...
 */
+(void)selectEnvironmentWithType: (PPHSDKServiceType) serviceType andCountryCodeOrNil:(NSString *)countryCode;
