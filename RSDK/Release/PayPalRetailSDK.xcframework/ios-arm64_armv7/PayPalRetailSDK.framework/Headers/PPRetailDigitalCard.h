/**
 * PPRetailDigitalCard.h
 *
 * DO NOT EDIT THIS FILE! IT IS AUTOMATICALLY GENERATED AND SHOULD NOT BE CHECKED IN.
 * Generated from: node_modules/@paypalcorp/retail-payment-device/src/DigitalCard.js
 *
 * 
 */
...
/*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*/
/**
 * Holds Gift Card information used for the Payment
 */
@interface PPRetailDigitalCard : PPRetailCard
/**
 * online redemption Code
 */
