...
typedef NS_ENUM(NSInteger, PPRetailSdkError) {
  ...
  PPRetailSdkErrorrapidSuccessiveCall = 11,
  PPRetailSdkErrorreaderAlreadyConnected = 12,
  PPRetailSdkErrorstoppingAutoConnect = 13
};

/**
 * Transaction Error name to code
 */
typedef NS_ENUM(NSInteger, PPRetailTransactionError) {
  PPRetailTransactionErrorcustomerCancel = 1,
  PPRetailTransactionErrorgenericCancel = 2,
  PPRetailTransactionErrorcardCantContinue = 3,
  PPRetailTransactionErrornoFunctionalDevices = 4,
  PPRetailTransactionErrorinvoiceStatusMismatch = 5,
  PPRetailTransactionErroramountTooLow = 6,
  PPRetailTransactionErroramountTooHigh = 7,
  PPRetailTransactionErrorfailedToCollectSignature = 8,
  PPRetailTransactionErrorcannotSwipeChipCard = 9,
  PPRetailTransactionErrormustSwipeCard = 10,
  PPRetailTransactionErrorrefundCardMismatch = 11,
  PPRetailTransactionErrorcardTypeMismatch = 12,
  PPRetailTransactionErrorlocationError = 13,
  PPRetailTransactionErrormissingInvoiceId = 14,
  PPRetailTransactionErrormissingTransactionNumberOrInvoiceId = 15,
  PPRetailTransactionErrorcannotDiscardCard = 16,
  PPRetailTransactionErrormultipleContactlessCardsDetected = 17,
  PPRetailTransactionErrortryDifferentInterface = 18,
  PPRetailTransactionErrorcannotClearActiveTransaction = 19,
  PPRetailTransactionErrorauthorizationFailed = 20,
  PPRetailTransactionErrorcaptureFailed = 21,
  PPRetailTransactionErrorinvalidAuthorization = 22,
  PPRetailTransactionErrorretrieveAuthListFailed = 23,
  PPRetailTransactionErrorvoidFailed = 24,
  PPRetailTransactionErrornotSupported = 25,
  PPRetailTransactionErrorcaptureValidationFailed = 26,
  PPRetailTransactionErrorauthRetrieveValidationFailed = 27,
  PPRetailTransactionErrorinvalidInvoiceItem = 28,
  PPRetailTransactionErrorofflinePaymentEnabled = 29,
  PPRetailTransactionErrorofflineTxnLimit = 30,
  PPRetailTransactionErrorofflineTotalLimit = 31,
  PPRetailTransactionErrornoAudioReaderWhenOffline = 32,
  PPRetailTransactionErrornfcContactlessLimitReached = 33,
  PPRetailTransactionErrorofflinePaymentStopped = 34,
  PPRetailTransactionErrorofflinePaymentKeyinNotAllowed = 35,
  PPRetailTransactionErrorpayAndVaultFailed = 36,
  PPRetailTransactionErrorvaultFailed = 37,
  PPRetailTransactionErrorinvoiceLoadFailed = 38,
  PPRetailTransactionErrormissingTransactionNumber = 39,
  PPRetailTransactionErrorfailedDueToOutage = 40,
  PPRetailTransactionErrorqrcSessionTimeOut = 41,
  PPRetailTransactionErrorqrcPollingFailed = 42,
  PPRetailTransactionErrorcannotCancelActiveQrcTransaction = 43,
  PPRetailTransactionErrorfailedQRCServiceProvider = 44,
  PPRetailTransactionErrorfailedQRCUrlGeneration = 45,
  PPRetailTransactionErrorfailedQRC = 46,
  PPRetailTransactionErrordeclinedQRC = 47,
  PPRetailTransactionErrorfailedQRCReferrerCode = 48,
  PPRetailTransactionErrormerchantCancel = 49,
  PPRetailTransactionErrorcancellationFailure = 50,
  PPRetailTransactionErrormissingDigitalCardRedemption = 51
};

/**
 * Merchant Error name to code
 */
typedef NS_ENUM(NSInteger, PPRetailMerchantError) {
  PPRetailMerchantErrorfailedToLoad = 1,
  PPRetailMerchantErrorrequiredInfoNotLoaded = 2,
  PPRetailMerchantErrornotInitialized = 3,
  PPRetailMerchantErrormissingCredentials = 4,
  PPRetailMerchantErrorenvironmentNotProvided = 5,
  PPRetailMerchantErrormerchantDataNotProvided = 6,
  PPRetailMerchantErrorinvalidMerchantUserInfo = 7,
  PPRetailMerchantErrorinvalidMerchantStatusInfo = 8,
  PPRetailMerchantErrorinvalidToken = 9,
  PPRetailMerchantErrortokenDataNotProvided = 10,
  PPRetailMerchantErrorofflinePaymentIneligible = 11,
  PPRetailMerchantErrorofflineInfoNotAvailable = 12,
  PPRetailMerchantErrorfailedToLoadOfflineMerchant = 13,
  PPRetailMerchantErrorfailedToReloadOnlineMerchant = 14,
  PPRetailMerchantErrormerchantInitializedCallbackNotProvided = 15,
  PPRetailMerchantErrorwebFeatureNotEnabled = 16,
  PPRetailMerchantErrorqrcIneligible = 17
};
