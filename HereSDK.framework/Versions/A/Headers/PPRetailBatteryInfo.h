 ...
 * Generated from: node_modules/retail-payment-device/src/BatteryInfo.js
 *
 * 
 */
...
@interface PPRetailBatteryInfo : PPRetailObject
    ...
    */
    ...
    - (instancetype _Nullable)initWithPercentage:(int)percentage isCharging:(BOOL)isCharging measuredOn:(NSDate* _Nullable)measuredOn;
