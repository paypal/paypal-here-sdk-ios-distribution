...
module.exports = {
  ...
  Tx: {
    Alert: {
      ...
      IncorrectPin: {
        Title: 'Incorrect PIN',
        Message: 'The PIN entered was incorrect.  Please try again.',
      },
      ...
      BlockedCard: {
        Title: 'Declined',
        Msg: 'Please contact the card provider for more information',
      },
      BlockedCardInserted: {
        Title: 'Declined',
        Msg: 'Please remove the card and contact the card provider for more information',
      },
      BlockedCardTapped: {
        Title: 'Declined',
        Msg: 'Please contact the card provider for more information',
  ...
  EMV: {
    ...
    ProcessingPinOk: 'Processing... PIN correct',
    PinOk: 'PIN correct',
