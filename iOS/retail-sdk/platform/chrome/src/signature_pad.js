 ...
 *
 */
// Modified by Max Metral to deal with being in a chrome app and run from the background/SDK context

var SignaturePad = function (w, canvas, options) {
    var self = this,
        opts = options || {};
...
SignaturePad.prototype._handleTouchEvents = function () {
    ...
    this.document.addEventListener('touchend', function (event) {
