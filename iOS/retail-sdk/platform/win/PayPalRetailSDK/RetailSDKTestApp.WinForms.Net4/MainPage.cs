...
namespace RetailSDKTestApp.WinForms.Net4
{
    public partial class MainPage : Form
    {
        ...
        private string DefaultSdkToken => new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("RetailSDKTestApp.WinForms.Net4.testToken.txt")).ReadToEnd();
