...
/*!
 * PPHLocalManager provides a "jumping off point" for manipulating merchant locations and watching open and closed tabs
 */
@interface PPHLocalManager : NSObject

/*!
 * Get an object that will notify delegate of new and removed tabs from customers
 ...
 * @param delegate the object that will be notified when tabs are opened or closed. Note that at the moment you have
